...
export const defaultSlashSuggestions: SuggestionOptions<SuggestionItem>['items'] =
  () => [
    {
      title: 'Texto',
      description: 'Simplemente empieza a escribir con texto simple.',
    ...
    },
    {
      ...
      description:
        'Realice un seguimiento de las tareas con una lista de tareas pendientes.',
    ...
    {
      title: 'Encabezado 3',
      description: 'Encabezado de sección pequeña.',
    ...
    },
    {
      ...
      description: 'Crea una lista con viñetas sencilla.',
    ...
    {
      title: 'Tabla',
      description: 'Agregar una vista de tabla para organizar los datos.',
      searchTerms: ['table'],
      icon: TableIcon,
      command: ({ editor, range }) =>
        editor
...
export const EditorBubbleMenu = ({
  ...
  return (
    <BubbleMenu
      className={cn(
        'flex rounded-xl border bg-background p-0.5 shadow relative !z-[50]',
